...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    DRAGONFLY("dragonfly", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.DRAGONFLYCARAPACE.get());


    }),


    BREATHER("breather", 15, new int[]{2, 5, 5, 2}, 9, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.ITYPESKULL.get());
