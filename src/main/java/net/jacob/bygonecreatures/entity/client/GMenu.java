...
public class GMenu extends AbstractContainerMenu {

    private final Container luggageContainer;
    private final GlyptodonEntity luggage;
    private final int containerRows;

    public GMenu(int id, Inventory inventory, Container container, GlyptodonEntity luggage) {
