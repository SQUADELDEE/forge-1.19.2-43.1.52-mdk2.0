...
public class AukRenderer extends GeoEntityRenderer<AukEntity> {

    public AukRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new AukModel());
        this.shadowRadius = 0.3f;
    }

    @Override
    public ResourceLocation getTextureLocation(AukEntity instance) {
    ...
    @Override
    public RenderType getRenderType(AukEntity animatable, float partialTicks, PoseStack stack,
